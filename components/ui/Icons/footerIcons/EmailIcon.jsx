...
const EmailIcon = () => {
  return (
    <svg viewBox="0 0 99.999995 99.999995">
      <defs id="defs4">
        <filter id="filter4510" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood floodOpacity="0.470588" id="feFlood4512" result="flood" />
          <feComposite
            id="feComposite4514"
            in="flood"
            in2="SourceGraphic"
        ...
        <filter id="filter5064" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood id="feFlood5066" result="flood" />
          <feComposite
            id="feComposite5068"
            in="flood"
            in2="SourceGraphic"
        ...
        <filter id="filter5364" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood id="feFlood5366" result="flood" />
          <feComposite
            id="feComposite5368"
            in="flood"
            in2="SourceGraphic"
        ...
        <filter id="filter4400" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood floodOpacity="0.470588" id="feFlood4402" result="flood" />
          <feComposite
            id="feComposite4404"
            in="flood"
            in2="SourceGraphic"
        ...
        <filter id="filter4678" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood
            floodColor="rgb(255,253,180)"
            floodOpacity="1"
            id="feFlood4680"
        ...
        <filter id="filter5045" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood
            floodColor="rgb(255,250,175)"
            floodOpacity="1"
            id="feFlood5047"
            result="flood"
          />
        ...
        <filter id="filter4607" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood
            floodColor="rgb(255,247,180)"
            floodOpacity="1"
            id="feFlood4609"
            result="flood"
          />
        ...
        <filter id="filter4507" style={{ colorInterpolationFilters: "sRGB" }}>
          <feFlood
            floodColor="rgb(255,249,199)"
            floodOpacity="1"
            id="feFlood4509"
            result="flood"
          />
